<%@ Page Language="VB" AutoEventWireup="false" CodeFile="nuisance.aspx.vb" Inherits="nuisance" %>
<!DOCTYPE>
<html lang="en">
    <head id="headNuisance" runat="server">
        <meta charset="utf-8" />
                                ...
                                <asp:UpdatePanel ID="updateStartCase"
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <br />
                                         ...
                                         <asp:Label ID="lblLotType" runat="server" Text="Lot Type:" EnableViewState="false">
                                        ...
                                        <br />
                                         ...
                                         <asp:Label ID="lblVacantLotDescription" runat="server" Text="Vacant Lot Desc.:" EnableViewState="false">
                                        
                                        </asp:Label>

                                        <br />

                                        <asp:TextBox ID="txtVacantLotDescription" runat="server" MaxLength="200" Wrap="true" CssClass="multiLine" TextMode="MultiLine" Enabled="false">
                                        ...
                                        <asp:Label ID="lblViolations" runat="server" Text="Violations:" EnableViewState="false">
                                        
                                        </asp:Label>

                                        <br />
                                
                                        <asp:ListBox ID="lstViolations" runat="server" Enabled="false" AppendDataBoundItems="true" AutoPostBack="false" SelectionMode="Multiple" CssClass="violationList">
                                        ...
                                        <asp:TextBox ID="txtInspectionComments" runat="server" TextMode="MultiLine" Enabled="false" CssClass="multiLine">
                                        </asp:TextBox>

                                        <br />
                                        <asp:Label ID="lblLetterComments" runat="server" Text="Letter Comments:" EnableViewState="false">
                                        </asp:Label>

                                        <br />

                                        <asp:TextBox ID="txtLetterComments" runat="server" TextMode="MultiLine" Enabled="false" CssClass="multiLine">
                                        </asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txtComplaintDate" runat="server" Enabled="false">

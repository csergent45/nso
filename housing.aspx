<%@ Page Language="VB" AutoEventWireup="false" CodeFile="housing.aspx.vb" Inherits="housingUhh" %>
<!DOCTYPE>
<html lang="en">
    <head id="headHousingUhh" runat="server">
        <meta charset="utf-8" />
        <title>Housing</title>
                                ...
                                <asp:UpdatePanel ID="updateStartCase"
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <br />
                                         ...
                                         <asp:Label ID="lblInspectionComments" runat="server" Text="Inspection Comments:" EnableViewState="false">
                                        
                                        </asp:Label>

                                        <br />

                                        <asp:TextBox ID="txtInspectionComments" runat="server" placeholder="Insp. Comments" TextMode="MultiLine" Wrap="true" CssClass="multiLine" Enabled="false">
                                        </asp:TextBox>
                                        ...
                                        <asp:TextBox ID="txtLetterComments" runat="server" placeholder="Letter Comments" TextMode="MultiLine" Wrap="true" CssClass="multiLine" Enabled="false">
                                        </asp:TextBox>
